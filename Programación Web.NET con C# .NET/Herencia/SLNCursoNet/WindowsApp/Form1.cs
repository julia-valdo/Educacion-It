...
namespace WindowsApp
{
    public partial class Form1 : Form
    {
        ...
        {
            Empresa empresa = new Empresa("Carrefour", "30-58462038-9", "Lunes a Domingo 9:00 a 18:00 hs.", "carrefour@hotmail.com", "0 800 444 8484", "Calle 123");
        ...
        {
            Factura factura = new Factura("A", "12345", "Julia Valdovinos", "Av. Rivadavia 666", "Responsable Inscripto", "Consumidor Final", "Compra de bebida gaseosa", 126, new DateTime(2021, 10, 14));
